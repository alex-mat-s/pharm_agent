...
- FDA Drugs@FDA / openFDA — Drugs@FDA включает большинство препаратов, одобренных FDA с 1939 года, а openFDA даёт машиночитаемый JSON-доступ и обновляется по будням. 
